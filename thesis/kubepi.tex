...
Poniższy listing przestawia konfigurację całej aplikacji. Dzięki użyciu biblioteki \textit{restful-go} w prosty sposób można stworzyć serwer bazujący na architekturze REST.
...
% TODO
\begin{lstlisting}[language=golang,float,floatplacement=H]
