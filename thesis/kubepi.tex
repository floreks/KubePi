...
\begin{lstlisting}[caption=Plik do budowania aplikacji w architekturze X86/AMD64 i ARM,label=lst:compiling]
...
\begin{lstlisting}[language=yaml,caption=Definicja aplikacji uruchamianej w klastrze 1,label=lst:yaml-start]
kind: List
apiVersion: v1
items:
- kind: Deployment
...
\begin{lstlisting}[language=yaml,caption=Definicja aplikacji uruchamianej w klastrze 2,label=lst:yaml-end,float]             
...
            volumeMounts:
