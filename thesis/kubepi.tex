...
\subsubsection{Źródła z zakresu wirtualizacji}
	\indent Wirtualizacja jako jedno z podstawowych zagadnień poruszanych w pracy musiało zostać dobrze wyjaśnione. Tutaj również dużą rolę odniosło własne doświadczenie, wraz z wykorzystaniem książki \textit{Virtualization Essentials} \cite{virtualization}.
...
Docker bazuje na modelu klient-serwer. Klient Dockera komunikuje się z demonem\footnote{Demon (ang. daemon) - program lub proces, wykonywany wewnątrz środowiska systemu operacyjnego, bez konieczności interakcji z użytkownikiem \cite{daemon}.}, który odpowiada za tworzenie, uruchamianie oraz dystrybucję kontenerów. Zazwyczaj oba te komponenty uruchamiane są na tej samej maszynie, jednak możliwe jest uruchomienie demona na zdalnej maszynie i podłączenie się do niej za pomocą aplikacji klienckiej. Architektura została pokazana na poniższym rysunku. Każdy z komponentów ma określone zadania, które zostaną opisane poniżej.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.05\textwidth]{images/dockerSwarmArch.jpg}
...
\begin{thebibliography}{99}
	...
	\bibitem{dht11Botland} {}
	\bibitem{ds18b20Botland} {}
	\bibitem{max7219Botland} {}
	\bibitem{mq3Botland} {}
	\bibitem{gorestful} {}
	\bibitem{gorpio} {}
	\bibitem{godht} {}
	...
	\bibitem{spidev} {}	
	\bibitem{flannel} {}
	\bibitem{kubepi} {https://github.com/floreks/KubePi - [dostęp 05.05.2017]}			\bibitem{xgo} {}	
	% obrazki
